        ...
        <div className="container mx-auto px-4 py-4">
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2 animate-in slide-in-from-top">
              ...
              <Link to="/products" className="block py-2 text-primary font-medium">
                Produk
              </Link>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredProducts.map((product) => (
            <Card key={product.id} className="overflow-hidden hover:shadow-strong transition-all duration-300 hover:-translate-y-1">
